...
export default function ChineseProgramsCarousel() {
  ...
  return (
    <section className="w-[90%] max-w-7xl mx-auto px-4 py-10">
      <h2 className="text-3xl md:text-5xl font-bold text-center mb-2 text-[#9F0A0B]">Aspirely</h2>
      <p className="text-center text-neutral-700 mb-6 md:text-2xl font-semibold">Luyện nói tiếng Trung mọi lúc, mọi nơi</p>
